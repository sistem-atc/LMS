...
class RoleResource extends Resource implements HasShieldPermissions
{
            ...
            ->schema([
                ...
                Forms\Components\Tabs::make('Permissions')
                    ...
                    ->tabs([
                        ...
                        static::getTabFormComponentForPanelPermissions(),
                    ])
                    ->columnSpan('full'),
            ]);
    }
    ...
    public static function getPanelOptions(): array
    {
        ...
        return MenuItems::getPanelsAvaliables()->toArray();
    }
    ...
    public static function getTabFormComponentForPanelPermissions(): Component
    {
        $options = static::getPanelOptions();
        $count = count($options);

        return Forms\Components\Tabs\Tab::make('panel')
            ->label(__('filament-shield::filament-shield.panels'))
            ->visible(fn(): bool => (bool) static::isPanelEntityEnabled() && $count > 0)
            ->badge($count)
            ->schema([
                static::getCheckboxListFormComponent('panel_permissions', $options),
            ]);
    }
