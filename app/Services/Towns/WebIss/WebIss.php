...
namespace App\CityHall\WebIss;


class WebIss
{
    Option Explicit
Private Type ClassType: Link_Prefeitura As String: Versao_Cabecalho As String: Versao_Assemble As String: NameSpace As String: Filial_Usada As String: End Type
...
Public Property Get Versao_Assemble() As String: Versao_Assemble = This.Versao_Assemble: End Property
Public Property Get NameSpace() As String: NameSpace = This.NameSpace: End Property
Public Property Let Prefeitura_Utilizada(Value As String): This.Filial_Usada = Value: This.Link_Prefeitura = Split(Links_Prefeituras.Item(Value), "|")(0): This.Versao_Cabecalho = Split(Links_Prefeituras.Item(Value), "|")(1): This.Versao_Assemble = Split(Links_Prefeituras.Item(Value), "|")(2): This.NameSpace = Split(Links_Prefeituras.Item(Value), "|")(3): End Property
...
Private Sub Class_Initialize()
    ...
    Links_Prefeituras.Add "AJX", "https://aracajuse.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Aracaju
    Links_Prefeituras.Add "AUX", "https://araguainato.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Araguaina
    Links_Prefeituras.Add "BGX", "https://bagers.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura de Bagé
    Links_Prefeituras.Add "DIV", "https://ws.nfe-cidades.com.br/ws/div|2.01|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Divinopolis
    Links_Prefeituras.Add "GRP", "https://gurupito.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Gurupi
    Links_Prefeituras.Add "ITN", "https://itabunaba.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Itabuna
    Links_Prefeituras.Add "PMW", "https://palmasto.webiss.com.br/ws/nfse.asmx|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura Palmas
    Links_Prefeituras.Add "JDF", "http://matiasbarbosamg.nfse-futurize.com.br/webservice/prod|2.02|0|http://schemas.xmlsoap.org/soap/envelope/" 'Prefeitura de Mathias Barbosa
    Links_Prefeituras.Add "FSA", "https://feiradesantanaba.webiss.com.br/ws/nfse.asmx|2.02|0|http://www.w3.org/2003/05/soap-envelope" 'Prefeitura Feira de Santana
...
Public Function ConsultarNfse(ByVal CNPJ As String, ByVal Inscricao_Municipal As String, ByVal Data_Inicio As Date, _
                              ByVal Data_Final As Date, ByVal Numero_Nota As String, ByVal Used_Companny As String) As Variant
...
Private Function Conection(ByVal Prefeitura As String, ByVal Mensage As String, ByVal Used_Companny As String, _
                           ByVal Operation As String) As Variant
...
Public Function Preecher_Template(ByVal Array_Dados_TNT As Variant, ByVal ParametersTemplate As Object, ByVal Dict_Xml As Object) As Variant
    ...
    Dim Descricao_Servico As cls_Descricao_Servico, DB_Connection As cls_DB_Connection, Url As String, Tratar_Caracteres As cls_Connection
    ...
    With htmlDoc
        ...
        Set Nodo = .getElementById("municipio_tomador")
            Set Tratar_Caracteres = New cls_Connection
            If Not Nodo Is Nothing Then Nodo.innerHTML = Tratar_Caracteres.Tratar_Caracteres(DictUF.Item("Nome Municipio"))
            Set Tratar_Caracteres = Nothing
