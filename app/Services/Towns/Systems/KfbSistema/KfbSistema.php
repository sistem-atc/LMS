...
namespace App\Services\Towns\Systems\KfbSistema;
...
Private Sub Class_Initialize()
    ...
    Links_Prefeituras.Add "TXF", "http://trbteixeira.kbfsistemas.com.br/webrun/webservices/NFEServices.jws|2.02" 'Prefeitura Teixeira de Freitas

End Sub

Public Function CancelarNfse(ByVal Used_Companny As String) As Variant

    Dim Mount_Mensage As String, Operacao As String, CabecMsg As String, DadosMsg As String, SOAPAction As String

    Operacao = "CancelarNfse": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    ...
    CancelarNfse = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function ConsultarLoteRps(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "ConsultarLoteRps": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    ConsultarLoteRps = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function consultarNfsePorFaixa(ByVal CNPJ As String, ByVal Inscricao_Municipal As String, ByVal Nota_Inicial As String, _
    ...
    Operacao = "ConsultarNfsePorFaixa": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao & "Request": Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    ...
    DadosMsg = Replace(DadosMsg, "[CAMPO_NOTA_FINAL]", Nota_Inicial)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    Mount_Mensage = Replace(Mount_Mensage, "[DadosMsg]", DadosMsg)

    consultarNfsePorFaixa = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function ConsultarNfsePorRps(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "ConsultarNfsePorRps": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    ConsultarNfsePorRps = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function ConsultarNfseServicoPrestado(ByVal CNPJ As String, ByVal Inscricao_Municipal As String, ByVal Data_Inicial As Date, _
                                             ByVal Data_Final As Date, ByVal Nota_Fiscal As String, ByVal Used_Companny As String, _
                                             Optional ByVal Numero_Pagina As Long = 1) As Variant

    Dim Mount_Mensage As String, Operacao As String, CabecMsg As String, DadosMsg As String, SOAPAction As String

    Operacao = "ConsultarNfseServicoPrestado": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    DadosMsg = Replace(DadosMsg, "[CAMPO_CNPJ]", CNPJ)
    DadosMsg = Replace(DadosMsg, "[CAMPO_INSCRICAO_MUNICIPAL]", Inscricao_Municipal)
    ...
    DadosMsg = Replace(DadosMsg, "[CAMPO_NOTA_FISCAL]", Nota_Fiscal)
    DadosMsg = Replace(DadosMsg, "[CAMPO_NUMERO_PAGINA]", Numero_Pagina)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    Mount_Mensage = Replace(Mount_Mensage, "[DadosMsg]", DadosMsg)

    ConsultarNfseServicoPrestado = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function ConsultarNfseServicoTomado(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "ConsultarNfseServicoTomado": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    ConsultarNfseServicoTomado = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function GerarNfse(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "GerarNfse": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    GerarNfse = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function RecepcionarLoteRps(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "RecepcionarLoteRps": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    RecepcionarLoteRps = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function RecepcionarLoteRpsSincrono(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "RecepcionarLoteRpsSincrono": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    RecepcionarLoteRpsSincrono = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Public Function SubstituirNfse(ByVal Used_Companny As String) As Variant
    ...
    Operacao = "SubstituirNfse": SOAPAction = Prefeitura_Utilizada & "/NFEServices/" & Operacao: Mount_Mensage = Message_Assemble
    CabecMsg = Compor_CabecalhoXML(Versao_Cabecalho)
    DadosMsg = Compor_MensagemXML(Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[Mount_Mensage]", Operacao)
    Mount_Mensage = Replace(Mount_Mensage, "[CabecMsg]", CabecMsg)
    ...
    SubstituirNfse = Conection(Prefeitura_Utilizada, Mount_Mensage, Used_Companny, SOAPAction)
...
Private Function Conection(ByVal Prefeitura As String, ByVal Mensage As String, ByVal Used_Companny As String, ByVal SOAPAction As String) As Variant
...
Private Function Message_Assemble() As String
    ...
    Message_Assemble = "<soapenv:Envelope xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:soapenv=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:def=""http://DefaultNamespace"">"
    Message_Assemble = Message_Assemble & "<soapenv:Header/>"
    Message_Assemble = Message_Assemble & "<soapenv:Body>"
    Message_Assemble = Message_Assemble & "<def:[Mount_Mensage] soapenv:encodingStyle=""http://schemas.xmlsoap.org/soap/encoding/"">"
    Message_Assemble = Message_Assemble & "<Nfsecabecmsg xsi:type=""xsd:string""><![CDATA[[CabecMsg]]]></Nfsecabecmsg>"
    Message_Assemble = Message_Assemble & "<Nfsedadosmsg xsi:type=""xsd:string""><![CDATA[[DadosMsg]]]></Nfsedadosmsg>"
    Message_Assemble = Message_Assemble & "</def:[Mount_Mensage]>"
    Message_Assemble = Message_Assemble & "</soapenv:Body>"
...
Public Function Preecher_Template(ByVal Array_Dados_TNT As Variant, ByVal ParametersTemplate As Object, ByVal Dict_Xml As Object) As Variant
    ...
    'Dict_Xml.Item("Status") <> 1 Tag Cancelamento
