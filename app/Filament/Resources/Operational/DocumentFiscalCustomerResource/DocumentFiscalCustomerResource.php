...
namespace App\Filament\Resources\Operational\DocumentFiscalCustomerResource;
...
use App\Filament\Resources\Operational\DocumentFiscalCustomerResource\Pages;
            ...
            ->schema([
                Section::make('')
                    ->schema([
                        Select::make('cUF')
                            ->label('Código da UF')
                            ->relationship('cUF', 'federation_unit'),
                        TextInput::make('mod')
                            ->label('Modelo')
                            ->maxLength(3),
