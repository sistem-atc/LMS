...
class CteResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Conhecimento de Transporte';
    protected static ?string $pluralModelLabel = 'Conhecimentos de Transportes';
    protected static ?string $navigationIcon = 'heroicon-o-truck';
    protected static ?string $navigationGroup = 'Operacional';
    protected static ?string $navigationLabel = 'Ctes';
